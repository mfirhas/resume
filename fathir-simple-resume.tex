...
\section{Summary}  
  {
    \textbf{Software Engineer} in \textbf{backend} development. Having knowledge in \textbf{Go Programming Language} and tools related. 
    Experienced in \textbf{microservices} architecture. 
    Recently started learning Rust and have interest in Rust-based project.
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Main Skills}{: Go, PostgreSQL, MySQL, MongoDB, Cache, gRPC, GraphQL, HTTP, Message Queue, Docker, Testing, Rust}
    }
    \item{
        \textbf{Lesser Skills}{: Java, Python, Javascript, HTML}
    }
  \resumeSubHeadingListEnd
