...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Software Engineer & Mobile : +62-812-2444-1284 \\
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Sarjana Komputer (S.Kom)}{2012 -- 2016}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Tech Stacks}
          {Java Spring with reactive framework(Spring Reactive), MongoDB, Redis, Kafka, RabbitMQ, etc.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Software Engineer}{Nov 2016 - Jun 2018}
      \resumeItemListStart
        \resumeItem{Tech Stacks}
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Main Tools}{: Go, PostgreSQL, MySQL, Javascript, Redis, gRPC, GraphQL, REST APIs, NSQ, Linux}
    }
    \item{
        \textbf{Other Tools}{: Java, C\#, Python, NodeJS}
    }
  \resumeSubHeadingListEnd
